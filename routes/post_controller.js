...
exports.search = function(req, res, next) {
  ...
  console.log("En el contralador de la ruta posts/search");

  var format = req.params.format || 'html';
  format = format.toLowerCase();

  stringDeBusqueda = '%' + req.query.search.replace(/ /g,"%") + '%';
  console.log(stringDeBusqueda);

  models.Post
  .findAll({where: ["title like ? OR body like ?", stringDeBusqueda, stringDeBusqueda], order: "updatedAt DESC"})
  .success(function(posts) {
    switch (format) { 
      case 'html':
      case 'htm':
